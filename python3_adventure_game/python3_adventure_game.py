...
def printStartMessage():
    ...
    sprint("Rumor has it that a gorgon is somewhere around here, and has been terrifying the nearby village.")
    sprint("In front of you is a house.")
    sprint("To your right is a dark cave.")
    sprint("In your hand you hold your trusty (but not very effective) dagger.")
...
def knock_on_door():
    ...
    sprint("You are about to knock when the door opens and out steps a pirate.")
    sprint("Eep! This is the pirate's house!")
    sprint("The pirate attacks you!")
    sprint("You feel a bit under-prepared for this, what with only having a tiny dagger.")
...
def fight():
    ...
    if(power<50):
        ...
        sprint("The Sword of Ogoroth shines brightly in your hand as you brace yourself for the attack.")
        sprint("But the troll takes one look at your shiny new toy and runs away!")
        sprint("You have rid the town of the troll. You are victorious!")
def run_away():
    sprint("You run back into the field. Luckily, you don't seem to have been followed.")
    begining_decision()
...
def peer_into_cave():
    ...
    if(chance>50):         
        ...
        sprint("You discard your silly old dagger and take the sword with you.")
        sprint("You walk back out to the field.")
    else:
        sprint("You've been here before, and gotten all the good stuff. It's just an empty cave now.")
        sprint("You walk back out to the field.")
    begining_decision()
